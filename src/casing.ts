...
export const RESERVED_KEYWORDS = new Set([
  ...
  'CATCH', 'CHECK', 'CHECKPOINT', 'CLOSE', 'CLUSTERED', 'COALESCE', 'COLLATE', 'COLUMN',
  ...
  'FILLFACTOR', 'FIRST', 'FOR', 'FOREIGN', 'FREETEXT', 'FREETEXTTABLE', 'FROM', 'FULL',
  ...
  'NEXT', 'NULLIF', 'OF', 'OFF', 'OFFSET', 'OFFSETS', 'ON', 'ONLY', 'OPEN', 'OPENDATASOURCE', 'OPENQUERY',
  ...
  'TRANSACTION', 'TRIGGER', 'TRUNCATE', 'TRY', 'TRY_CONVERT', 'TSEQUAL', 'UNION',
  ...
  // Cursor options
  'SCROLL', 'INSENSITIVE', 'DYNAMIC', 'STATIC', 'KEYSET', 'FAST_FORWARD',
  'FORWARD_ONLY', 'SCROLL_LOCKS', 'OPTIMISTIC', 'TYPE_WARNING',
  'LOCAL', 'GLOBAL', 'READ_ONLY', 'PRIOR', 'LAST', 'ABSOLUTE', 'RELATIVE',
  // Batch separator
  'GO',
]);
